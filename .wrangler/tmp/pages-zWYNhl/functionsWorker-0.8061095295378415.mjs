...
// api/register.ts
var ALLOWED_IMAGE_TYPES = /* @__PURE__ */ new Set(["image/png", "image/jpeg"]);
...
async function notifyAdmin(title, message, priority = "high") {
  try {
...
async function onRequestPost(context) {
  ...
  const str = /* @__PURE__ */ __name((name) => form.get(name)?.trim() ?? "", "str");
  if (str("company")) {
  ...
  proofPath = `proofs/${registrationRef}.${EXT_BY_TYPE[file.type]}`;
  ...
  for (let attempt = 0; attempt < 3 && !inserted; attempt++) {
    try {
      await context.env.DB.prepare(
        ...
        data.email,
        data.phone,
        data.school_board || null,
        data.emergency_contact_name || null,
        data.emergency_contact_phone || null,
        data.accompanied ? 1 : 0,
        data.consent ? 1 : 0,
        proofPath,
        "submitted",
        registrationRef
      ...
      if (/UNIQUE|unique/i.test(msg) && attempt < 2) {
        try {
          await context.env.PAYMENT_PROOFS.delete(proofPath);
        } catch {
        }
...
// ../.wrangler/tmp/pages-zWYNhl/functionsRoutes-0.056866360444778996.mjs
var routes = [
  {
...
// C:/Users/imris/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/imris/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/imris/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/imris/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-Lc9XmY/middleware-insertion-facade.js
...
// C:/Users/imris/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-Lc9XmY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8061095295378415.mjs.map
