  ...
  return (
    <div className="bg-white rounded-2xl border border-summit-orange-100 shadow-xl shadow-summit-orange-900/5 overflow-hidden animate-scale-in">
      <div className="bg-gradient-to-br from-summit-orange-600 to-summit-orange-700 px-6 py-8 text-center">
        ...
        <p className="text-sm text-white/75">Your registration is complete.</p>
      </div>
      <div className="p-6 lg:p-8">
        ...
        <div className="mt-5 bg-summit-orange-50 rounded-xl px-4 py-4">
          <p className="text-sm text-summit-charcoal/80 font-semibold">REGISTRATION SUCCESSFUL</p>
          <p className="text-sm text-summit-charcoal/70 mt-1">Your seat has been reserved successfully.</p>
          <p className="text-sm text-summit-charcoal/70 mt-1 break-all">Registration ID: {registration.registration_ref || `AFFS-${registration.id.slice(0, 8).toUpperCase()}`}</p>
        </div>
