        ...
        <div ref={ref} className={`reveal ${visible ? 'is-visible' : ''}`}>
          ...
          <div className="mt-10">
            <div className="overflow-hidden rounded-2xl border border-summit-orange-100 bg-white p-2 shadow-lg sm:p-3">
              <img
                src="/ChatGPT_Image_Sep_13%2C_2026%2C_11_22_25_AM.png"
                alt="Six-stage Akal Young Future Founders Summit journey from meeting and discovery to pitching"
            ...
            <Link
              to="/program"
              className="mt-8 inline-flex items-center gap-2 rounded-xl bg-[#f8cda9] px-7 py-3.5 text-base font-semibold text-summit-charcoal shadow-md transition-all hover:bg-[#f5bd8f] hover:shadow-lg"
            >
              Explore the Program
