        ...
        <div ref={ref} className={`reveal ${visible ? 'is-visible' : ''}`}>
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
            <div className="lg:col-span-5">
              <div className="inline-flex items-center rounded-md border border-summit-charcoal/40 bg-white px-3 py-2 text-xs font-medium text-summit-charcoal mb-4">Akal Academy, Baru Sahib<br />In collaboration with ISB</div>
              ...
              <a href="https://www.akalacademy.in/" target="_blank" rel="noreferrer" aria-label="Visit the Akal Academy website" className="group block relative aspect-square overflow-hidden rounded-2xl border border-summit-orange-100 bg-white p-2 shadow-lg transition-shadow hover:shadow-xl sm:p-3">
                <img src={schoolImage} alt="Akal School campus in the mountains" className="h-full w-full rounded-xl object-cover transition-transform duration-500 group-hover:scale-[1.03]" loading="lazy" />
              </a>
            </div>
            <div className="lg:col-span-7">
              ...
              <Link to="/program" className="group mt-8 inline-flex items-center gap-2 bg-summit-charcoal hover:bg-summit-charcoal/90 text-white font-semibold text-sm px-5 py-3 rounded-xl transition-all hover:shadow-lg">Explore the Program <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /></Link>
            </div>
          </div>
        </div>
      </div>
